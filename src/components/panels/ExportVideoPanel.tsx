    ...
    <>
      ...
      <div className="px-[16px]">
        <div className="flex flex-row items-center my-2">
          ...
          <input
            type="number"
            className="rounded text-center border-slate-200 placeholder-slate-400 contrast-more:border-slate-400 contrast-more:placeholder-slate-500 max-w-[50px] mr-2 text-black"
